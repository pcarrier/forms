...
func form*(value: float64): Form = Form(kind: F64, f64: value)
func form*(value: float32): Form = Form(kind: F32, f32: value)
func formF16*(value: float64): Form = Form(kind: F16, f16: value)
